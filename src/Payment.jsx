...
setOrderId(generateUniqueId());
  ...
  const purchaseStatus = async () => {
    try{
      const response = await axios.put(`${import.meta.env.VITE_BASE_URL}/posts/productstatus`, {purchased, orderId},{
          withCredentials:true
        });
  ...
  const handlePayment = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(`${import.meta.env.VITE_BASE_URL}/posts/addpayment`, {cardNumber, expiration, cvc, cardholderName, orderId }, {
        withCredentials: true,
      });
      res;
